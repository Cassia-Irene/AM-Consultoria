/* 
  Q13: Fluxo da Semana (Visitas Programadas)
  Objetivo: Filtrar visitas dos próximos 7 dias para visualização de carga no Hub de Planejamento.
*/
...
SELECT 
    ...
    (SELECT resultados FROM visitas v2 WHERE v2.id_contrato = v.id_contrato AND v2.data_hora < v.data_hora ORDER BY v2.data_hora DESC LIMIT 1) as ultima_visita_resultados,
